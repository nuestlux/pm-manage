...
2. **Follow Workflows**: Strictly follow the defined workflows in `./.agent/workflows/` or global `C:\Users\ADMIN\.gemini\.agent\workflows\`.
...
- **Global Workflows**: `C:\Users\ADMIN\.gemini\.agent\workflows\`
- **Global Commands**: `C:\Users\ADMIN\.gemini\.agent\workflows\commands\`
- **Global Skills**: `C:\Users\ADMIN\.gemini\.agent\skills\`
- **MCP Config**: `C:\Users\ADMIN\.gemini\antigravity\mcp_config.json`
- **GEMINI.md**: `C:\Users\ADMIN\.gemini\GEMINI.md`
...
- **Project Skills**: `./.agent/.claude/skills/` or `./.agent/skills/`

## Execution Rules

1. **Project-First**: Always prioritize project-specific configurations over global ones.
2. **Fallback to Global**: If project doesn't have `.agent`, use global `C:\Users\ADMIN\.gemini\.agent\`.
...
# Global
C:\Users\ADMIN\.gemini\.agent\skills\.venv\Scripts\python.exe scripts\xxx.py
```
...
# Global
~/.gemini/.agent/skills/.venv/bin/python3 scripts/xxx.py
```
